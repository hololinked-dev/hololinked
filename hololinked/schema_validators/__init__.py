...
from .validators import JSONSchemaValidator as JSONSchemaValidator
from .validators import PydanticSchemaValidator as PydanticSchemaValidator


SchemaValidatorClasses.json_schema = JSONSchemaValidator
SchemaValidatorClasses.pydantic = PydanticSchemaValidator
