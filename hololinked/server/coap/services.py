...
from hololinked.serializers.payloads import SerializableData
...
class ThingDescriptionService:
    ...
    def __init__(
        ...
        from . import CoAPServer  # noqa: F401
        ...
        self.thing = None  # type: Any
        self.server = server  # type: CoAPServer
    ...
    def add_security_definitions(self, TD: dict[str, JSONSerializable]) -> None:
        ...
        from ...td.security_definitions import NoSecurityScheme
