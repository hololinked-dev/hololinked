...
class TestEvents(TestCase):
    ...
    def _test_dispatcher(
        self, descriptor: Event, dispatcher: EventDispatcher, thing: TestThing
    ):
        ...
        self.assertTrue(
            dispatcher._owner_inst is thing
        ...
        self.assertEqual(
            dispatcher._unique_identifier, f"{thing._qualified_id}/{descriptor.name}"
        )
    ...
    def test_1_pure_events(self):
        ...
        self._test_dispatcher(
            TestThing.test_event, thing.test_event, thing
    ...
    def test_2_observable_events(self):
        ...
        self.assertIsInstance(
            TestThing.observable_list_prop._observable_event_descriptor, Event
        )
        self.assertIsInstance(TestThing.state._observable_event_descriptor, Event)
        self.assertIsInstance(
            TestThing.observable_readonly_prop._observable_event_descriptor, Event
        )
        ...
        self.assertTrue(
            hasattr(TestThing, TestThing.state._observable_event_descriptor.name)
        )
        self.assertTrue(
            hasattr(
                TestThing,
