...
- its not a solution that uses "different set of technologies to solve the same problem". It solves a problem irrespective of the underlying technogies. AI included. You chose the tech stack or extend it with your stack (PRs welcome for new tech adapters and new features).  
